 ...
 * Generated for Laravel 6.18.10 on 2020-04-22 06:43:12.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Cache {
        ...
        /**
         * Pharmacy multiple items in the cache for a given number of seconds.
         *
         * @param array $values
         * @param \DateTimeInterface|\DateInterval|int|null $ttl
         * @return bool 
        ...
        /**
         * Pharmacy an item in the cache if the key does not exist.
         *
         * @param string $key
         * @param mixed $value
         * @param \DateTimeInterface|\DateInterval|int|null $ttl
        ...
        /**
         * Pharmacy an item in the cache indefinitely.
         *
         * @param string $key
         * @param mixed $value
         * @return bool 
        ...
        /**
         * Pharmacy an item in the cache for the default time.
         *
         * @param string $key
         * @param mixed $value
         * @return void 
    ...
    class Storage {
        ...
        /**
         * Pharmacy the uploaded file on the disk.
         *
         * @param string $path
        ...
        /**
         * Pharmacy the uploaded file on the disk with a given name.
         *
         * @param string $path
         * @param \Illuminate\Http\File|\Illuminate\Http\UploadedFile|string $file
         * @param string $name
